...
import { SponsorRegistrationFormData, activationPreferenceOptions, yesNoMaybeOptions } from "@/types/sponsors/registration";
      ...
      <div className="space-y-4">
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Select your preferred way to activate your sponsorship or enter a custom preference
              </p>
        ...
        {activationPreferences === "OTHER" && (
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Please specify your activation preference *</FormLabel>
                <FormControl>
                  <Textarea
        ...
        {!activationPreferenceOptions.some(opt => opt.value === activationPreferences) && 
         activationPreferences && 
         activationPreferences !== "OTHER" && (
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Custom Activation Preference:</strong> {activationPreferences}
            </p>
          </div>
        )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>2. Do you plan to launch a new product during the event?</FormLabel>
              <Select onValueChange={field.onChange} value={field.value || ""}>
                <FormControl>
                  <SelectTrigger>
        ...
        <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
          <h4 className="font-medium text-gray-900 mb-2">Activation Options Include:</h4>
