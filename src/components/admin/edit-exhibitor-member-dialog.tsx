      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Edit Exhibitor Member
          </DialogTitle>
          <DialogDescription>
            Update the exhibitor member profile. Only email is required.
          </DialogDescription>
        </DialogHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Marine Engineer" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Maritime Solutions Inc" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
